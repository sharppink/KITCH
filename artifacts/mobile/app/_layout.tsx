...
export default function RootLayout() {
  /** 네이티브: AsyncStorage의 API 주소를 읽기 전에는 fetch가 잘못된 기본 LAN을 쓸 수 있음 → 준비될 때까지 렌더 지연. 웹은 모듈 로드 시 동기 bootstrap. */
  const [apiBaseReady, setApiBaseReady] = React.useState(Platform.OS === 'web');
  ...
  if (!apiBaseReady && Platform.OS !== 'web') return null;
